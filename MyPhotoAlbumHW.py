...
title.pack(pady=10)
img_file = Image.open(r'C:\Users\PC\OneDrive - Wellington College India\Pictures\Camera Roll\WIN_20260919_10_18_04_Pro.jpg')
...
def show_details():
    ...
    info = Label(top, text='Taken on: 19 September 2026')
    info.pack(pady=10)
    place = Label(top, text='Location: My House')
    place.pack()
    top.mainloop()
